...
var Layout = React.createClass({
  ...
  render: function() {
    ...
    var style = (process.env.NODE_ENV==='production') ? <link rel="stylesheet" href="/assets/screen.css" /> : '';
    var style2 = (process.env.NODE_ENV==='production') ? <link rel="stylesheet" href="/assets/rain.css" /> : '';
